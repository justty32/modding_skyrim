...
調查 Steelfeathers 的「Populated」系列（城鎮 / 荒野道路 / 地城 / Hell 極限版）。同家族的 **Civil War 變體已另寫** → [populated-skyrim-civil-war.md](populated-skyrim-civil-war.md)，本檔不重複它；置放式巡邏的最小範例見 [immersive-patrols.md](../content/immersive-patrols.md)。本系列正是 idea #22「漂泊開拓慢活：有人住的聚落 + 有人走的荒野/道路」最直接的對照組。
