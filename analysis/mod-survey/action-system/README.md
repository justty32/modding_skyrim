...
- 詳見 [roadmap](../../../projects/ModForge/workflows/roadmap/README.md) 的動作系統相關項。

## 與其他層的邊界
- **不可生成**（純 SKSE DLL，僅列前置）：XPMSSE、Pandora 引擎本體、UBR、BDI/PIE/AMR 的 DLL、SCAR、DMK。
- **屬動畫資產管線**（非 esp record 層）：.hkx、hkanno 註釋——見 [havok-blender](../../../projects/ModForge/workflows/idea/asset-pipelines/animation/havok-blender.md)。
