...
調查**方法**寫在 → [`workflows/investigation/mod-survey-guide.md`](../../projects/ModForge/workflows/investigation/mod-survey-guide.md)
（怎麼解壓、怎麼用 CLI 探 esp、記憶體鐵律、該記什麼）。

ESM/FormID 抽取**工具參考** → [`workflows/investigation/esm-formid-access.md`](../../projects/ModForge/workflows/investigation/esm-formid-access.md)

全遊戲文本/清單**參考資料** → [`../game-data/`](../../projects/game-data/)（vanilla + mod 抽出的劇情/對白/書/清單）。
