...
2026-08-16 runtime result against the byte-identical upstream INI: PASS. SPID 7.3.0.16 registered `16/16 Perks` with no
...
2026-08-20 6.0.4 static revalidation: PASS. The official 6.0.4 INI retains the same SHA-256 and
the official ESP still defines `MAG_BastionControllerPerkNPC` while omitting `MAG_BastionNPC`.
The final whole-pack smoke will provide the new-version runtime log evidence.
